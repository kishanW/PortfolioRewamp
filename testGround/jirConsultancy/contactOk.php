	...
	<body>
		<div id='container'>
			...
			<div id='textContent'>
				...
				<br><br>
				<b style='color: white; background: #10b9c2; padding: 3px; border: 1px dotted white; width: 100%; text-shadow: #6374AB 1px 1px 2px; font-size: 11px'>
					Your message was sent succesfully.
					Thank you
					Admin@JirConsultancy.com
				</b>
				<br>
				<br>
