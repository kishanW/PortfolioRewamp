...
<li>
<?php 
	$ban1 = get_option('xand_banner1'); 
	$url1 = get_option('xand_url1'); 
	$lab1 = get_option('xand_lab1'); 
	$alt1 = get_option('xand_alt1');
?>
...
<li>
<?php 
	$ban2 = get_option('xand_banner2'); 
	$url2 = get_option('xand_url2'); 
	$lab2 = get_option('xand_lab2'); 	
	$alt2 = get_option('xand_alt2');
?>
...
<li>
<?php 
	$ban3 = get_option('xand_banner3'); 
	$url3 = get_option('xand_url3'); 
	$lab3 = get_option('xand_lab3'); 
	$alt3 = get_option('xand_alt3');	
?>
...
<li>
<?php 
	$ban4 = get_option('xand_banner4'); 
	$url4 = get_option('xand_url4');
	$lab4 = get_option('xand_lab4'); 
	$alt4 = get_option('xand_alt4');	
?>
