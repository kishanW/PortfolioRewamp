...
<?php endif; // end primary sidebar widgets  ?>
	...
	<h3>About</h3>
<p class="about">Futurosity Aperio was designed by Robert Ellis of <a href="http://www.futurosity.com/" title="Futurosity">Futurosity</a>. You will always find the latest information for this theme at <a href="http://www.futurosity.com/wordpress-theme-futurosity-aperio" title="WordPress Theme: Futurosity Aperio">WordPress Theme: Futurosity Aperio</a>. You can delete this text by editing <strong>sidebar.php</strong> in the <strong>futurosity_aperio</strong> theme folder.</p>
