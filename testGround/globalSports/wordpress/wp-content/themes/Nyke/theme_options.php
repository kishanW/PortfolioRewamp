...
$options = array (
    ...
    array(  "name" => "Featured posts",
            "type" => "title",
			"desc" => "This section customizes the featured post list.",
       		),
	   
	array(    "type" => "open"),
	
	array(   "name" => "Show Nivo slider",
      	     "id" => $shortname."_nivo",
     		 "type" => "select",		
	...
	array( 	"name" => "Nivo slider category",
			"desc" => "Select the category to be featured.",
	...
	array("name" => "Banner ad on header ",
			"desc" => "adsense or other ad scripts ( 468x60) .",
            "id" => $shortname."_ad2",
            "std" => "",
            "type" => "textarea"), 
