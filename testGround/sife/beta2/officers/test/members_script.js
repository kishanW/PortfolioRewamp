 ...
 */
function filler(){
    document.write("<h3>The list of members| Franklin SIFE<hr></h3>");
    document.write("<a href='excel/2011_01_30_members_list_excel.xlsx'><h3 style='width:200px; background: #d7f2fc; color: white; border: 1px solid #a8e4f8; padding: 5px; text-align: center'>Download it as a Excell file</h3></a>");	
