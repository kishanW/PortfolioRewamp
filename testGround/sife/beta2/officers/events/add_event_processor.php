...
class event_prj{		
	...
	function document_event(){
		...
		$event_nme=Trim(stripslashes($_POST['event_name'])); 
		$event_date=Trim(stripslashes($_POST['event_date']));
		$event_dsc=Trim(stripslashes($_POST['event_desc'])); 
		...
		fwrite($Handle, "\n<EVENT>\n");
		fwrite($Handle, "<ID>\n"); 
		fwrite($Handle, $event_id_count);
		fwrite($Handle, "\n</ID>\n");
		
		fwrite($Handle, "<TITLE>\n"); 
		fwrite($Handle, $event_nme);
		fwrite($Handle, "\n</TITLE>\n");
		...
		fwrite($Handle, "<DATE>\n"); 
		fwrite($Handle, $event_date);
		fwrite($Handle, "\n</DATE>\n");
		
		fwrite($Handle, "<DESC>\n"); 
		fwrite($Handle, $event_dsc);
		fwrite($Handle, "\n</DESC>\n");
