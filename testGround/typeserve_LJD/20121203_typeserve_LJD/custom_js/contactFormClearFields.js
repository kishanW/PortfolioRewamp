...
function checkFields(){
	...
	if(blnValid==false){
		...
		document.getElementById('formSubmitError').innerHTML= "<img src='custom_images/ic_cancel.png'>" + errorMsg;
...
function verifyEmail(){
	...
	var emailRegEx = /^[A-Z0-9._%+-]+@[A-Z0-9.-]+\.[A-Z]{2,4}$/i;
     if (document.contactForm.email.value.search(emailRegEx) == -1) {
		document.getElementById('formSubmitError').innerHTML= "<img src='custom_images/ic_cancel.png'>" + "Invalid email address entered.";
