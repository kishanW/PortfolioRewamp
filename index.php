		...
		<style type="text/css">
			@media screen and (max-width: 1110px){
				*{
				...
				#introText {font-size: 12pt;}*/
				#userInfo{width: 100%; background: #e74c3c;}
				#userInfo > #userPic{max-width: 50%;float: left;}
				#userInfo > #introText{max-width: 50%;float: left; }
